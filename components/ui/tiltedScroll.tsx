  ...
  return (
    <div>
      <div className="flex items-center justify-center">
        ...
        >
          {/* Change grid-cols-2 to grid-cols-1 to have one item per row */}
          <div className="mx-auto grid  ml-6 h-[150px] w-[200px] animate-skew-scroll grid-cols-2 gap-5 sm:w-[350px]">
            {items.map((item) => (
              <div
                key={item.id}
